# Taken last build of python 2.7 from here, extracted build and updated to latest version of alpine
# https://github.com/docker-library/python/blob/f1e613f48eb4fc88748b36787f5ed74c14914636/2.7/alpine3.11/Dockerfile

FROM alpine:3.19 as python27-alpine
